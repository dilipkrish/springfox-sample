...
@Controller
@RequestMapping(value = "/pet", produces = APPLICATION_JSON_VALUE, consumes = APPLICATION_JSON_VALUE)
...
public class PetApi {
    ...
    @RequestMapping(value = "/pet/{petId}",
            ...
            consumes = { APPLICATION_JSON_VALUE, APPLICATION_XML_VALUE }, method = RequestMethod.PUT)
    ...
    @RequestMapping(
            produces = { APPLICATION_JSON_VALUE, APPLICATION_XML_VALUE },
            consumes = { APPLICATION_JSON_VALUE, APPLICATION_XML_VALUE }, method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/findByStatus", produces = { APPLICATION_JSON_VALUE, APPLICATION_XML_VALUE }, method =
            RequestMethod.GET)
    ...
    public ResponseEntity<List<Pet>> findPetsByTags(@ApiParam(value = "Tags to filter by") @RequestParam("tags")
                                                    List<String> tags)
            throws NotFoundException {
        // do some magic!
        return new ResponseEntity<List<Pet>>(HttpStatus.OK);
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 200, message = "successful operation"),
            @ApiResponse(code = 400, message = "Invalid ID supplied") })
    @RequestMapping(value = "/{petId}", produces = { APPLICATION_JSON_VALUE, APPLICATION_XML_VALUE }, method =
            RequestMethod.GET)
    ...
    public ResponseEntity<Void> updatePetWithForm(
            ...
            @ApiParam(value = "Updated name of the pet") @RequestParam("name") String name,
            @ApiParam(value = "Updated status of the pet") @RequestParam("status") String status)
            throws NotFoundException {
        // do some magic!
        return new ResponseEntity<Void>(HttpStatus.OK);
    }
    ...
    public ResponseEntity<Void> uploadFile(@ApiParam(value = "ID of pet to update", required = true)
                                           @PathVariable("petId") Long petId,
                                           ...
                                           @RequestPart("file") MultipartFile inputStream)
            throws NotFoundException {
        // do some magic!
        return new ResponseEntity<Void>(HttpStatus.OK);
    }
